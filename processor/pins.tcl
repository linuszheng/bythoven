...
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to SRAM_CE
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to SRAM_OE
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to SRAM_WE
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to SRAM_LB
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to SRAM_UB
